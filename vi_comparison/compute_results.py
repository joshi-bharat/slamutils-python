...
if __name__ == "__main__":
    ...
    orb = folder / "data" / f"{dataset}" / "mono_imu" / "CameraTrajectory.txt"
    orb_traj = read_tum_trajectory(orb)

    # orb_traj = interpolate_traj(colmap_traj.timestamps, orb_traj)

    colmap_sync, orb_sync = sync.associate_trajectories(colmap_traj, orb_traj)
